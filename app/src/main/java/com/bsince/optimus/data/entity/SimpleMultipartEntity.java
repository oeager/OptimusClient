...
public class SimpleMultipartEntity implements HttpEntity {
    ...
    public SimpleMultipartEntity(Event<?> mEvent,ResponseHandler handler) {
    	this.mEvent = mEvent;
    ...
    public void addPart(String key,String dataName,byte [] data,String type) throws IOException{
    	if(type==null){
         ...
         // Headers
         out.write(createContentDisposition(key,dataName));
    ...
    public void addPart(String key, String streamName, InputStream inputStream, String type)
        ...
        out.write(CR_LF);
        out.flush();
        OptimusClient.silentCloseInputStream(inputStream);
    ...
    private void updateProgress(int count) {
        ...
        if(mEvent.loadingProcessor!=null){
        	handler.responProcessing(mEvent, bytesWritten, totalSize);
        }
    ...
    private class FilePart {
        ...
        public void writeTo(OutputStream out) throws IOException {
            ...
            try {
            	...
            	L.w(LOG_TAG, "Cannot close input stream", e);
            }
        }
    }
